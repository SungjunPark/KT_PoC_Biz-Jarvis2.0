...
for i in line:
    content = i[6]  # csv에서 뉴스 제목 또는 뉴스 본문 column으로 변경
    sentence = twitter.pos(i[6], norm=True, stem=True)
    temp = []
    temp_embedding = []
    all_temp = []
...
modelName = "Model_Classification/Bi_LSTM_model/BiLSTM.model"
